...
|        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |
| ESC*   |   F1   |   F2   |   F3   |   F4   |   F5   |   F6   |   F7   |   F8   |   F9   |  F10   |  F11   |  F12   | P SCN  |  HOME  |   END  | ScrLK  | Pause  |  DEL   |
...
|          |          |          |                                                        |        |   KC   |   MO   |        |        |        |        |        |        |
| CTRL     |   LGUI   | L ALT    |                      SPACE                             | R ALT  |  _RCTL |  _FN   |  LEFT  |  DOWN  | RIGHT  |   0    |   .    | ENTER  |
...
*/
	...
	LAYOUT(
    KC_ESC             ,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12             , KC_PSCR, KC_HOME, KC_END,  KC_SCROLLLOCK, KC_PAUSE, KC_DEL,
    ...
    KC_LCTL            ,  KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, KC_RCTL, LT(1,KC_APP)       , KC_LEFT, KC_DOWN, KC_RGHT, KC_P0        , KC_PDOT,  KC_PENT),
...
|         |        |        |        | DCRSE  |TOGGLE  |INCREASE| AG_NORM| AG_SWAP|        |        |        |                |  P UP  |        |        |        |        |
|_________|________|________|________|________|________|________|________|________|________|________|________|________________|________|________|________|________|________|
|          |          |          |                                                        |        |        |        |        |        |        |        |        |        |
|          |          |          |                                                        |        |        |        |  HOME  | P DOWN |  END   |        |        |        |
|__________|__________|__________|________________________________________________________|________|________|________|________|________|________|________|________|________|
...
*/
    ...
    BL_TOGG, _______, _______, _______, _______, _______, _______, _______             , _______           , KC_LOCK, _______, _______, _______,                   _______, _______, _______, _______,
    _______, _______, _______, _______, BL_DEC,  BL_TOGG, BL_INC,  MAGIC_UNSWAP_ALT_GUI, MAGIC_SWAP_ALT_GUI, _______, _______, _______, _______,          KC_PGUP, _______, _______, _______, _______,
